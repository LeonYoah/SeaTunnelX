...
This document describes the current HTTP API exposed by `seatunnel-capability-proxy`.
...
- `catalogName`
  - optional
  - default: `capability_proxy_catalog`
- `pluginJars`
...
```json
{
  "ok": true,
  "factoryIdentifier": "MySQL",
  "catalogName": "capability_proxy_catalog",
