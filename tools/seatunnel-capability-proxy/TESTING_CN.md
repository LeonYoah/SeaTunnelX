...
├── tools/
│   └── seatunnel-capability-proxy.jar
└── bin/
    └── seatunnel-capability-proxy.sh
```
...
cp tools/seatunnel-capability-proxy/target/seatunnel-capability-proxy-3.0.0-SNAPSHOT-2.12.15.jar \
  ${SEATUNNEL_PROXY_JAR}

cp tools/seatunnel-capability-proxy/bin/seatunnel-capability-proxy.sh \
