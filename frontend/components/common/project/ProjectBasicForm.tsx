...
export function ProjectBasicForm({
  ...
  useEffect(() => {
    const hasSeenTooltip = localStorage.getItem(
      'project-risk-level-tooltip-seen',
    );
      ...
      <div className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-2'} gap-4`}>
        <div className='space-y-2'>
          ...
          <Select
            ...
            onValueChange={(value) =>
              updateField('minimumTrustLevel', parseInt(value) as TrustLevel)
            }
          >
          ...
          <div className='flex items-center gap-2'>
            ...
            <TooltipProvider>
              <Tooltip open={showTooltip} onOpenChange={setShowTooltip}>
                ...
                <TooltipContent>
                  <p>
                    注：此参数使用方法已更新 2025/07/22 <br />{' '}
                    低于此分数的用户将无法查看、领取该项目的所有内容！
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          <div className='flex items-center gap-2'>
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                updateField('allowSameIP', checked === true)
              }
